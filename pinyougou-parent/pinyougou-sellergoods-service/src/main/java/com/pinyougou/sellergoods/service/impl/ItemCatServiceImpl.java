...
public class ItemCatServiceImpl implements ItemCatService {
    ...
    public ItemCatAndTypeName findOne(Long id) {
        ...
        TbTypeTemplate tbTypeTemplate = tbTypeTemplates.get(0);
        String typeName = tbTypeTemplate.getName();
        ItemCatAndTypeName itemCatAndTypeName = new ItemCatAndTypeName(tbItemCat,typeName);
        return itemCatAndTypeName;
    }
